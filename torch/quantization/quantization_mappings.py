...
DEFAULT_STATIC_QUANT_MODULE_MAPPINGS : Dict[Callable, Any] = {
    ...
    nni.ConvTransposeReLU1d: nniq.ConvTransposeReLU1d,
    nni.ConvReLU2d: nniq.ConvReLU2d,
    nni.ConvReLU3d: nniq.ConvReLU3d,
    nni.LinearReLU: nniq.LinearReLU,
    nniqat.ConvBn1d: nnq.Conv1d,
    nniqat.ConvReLU1d: nniq.ConvReLU1d,
    ...
    nnqat.Conv1d: nnq.Conv1d,
    nnqat.ConvTranspose1d: nnq.ConvTranspose1d
}
...
DEFAULT_QAT_MODULE_MAPPINGS : Dict[Callable, Any] = {
    ...
    nn.ConvTranspose1d: nnqat.ConvTranspose1d,
    ...
    nni.ConvTransposeReLU1d: nniqat.ConvTransposeReLU1d,
